...
/**
 * Gets the invoice data from the api
 */
let getInvoices = () => 
{
...
/**
 * Gets the client data from the api
 */
let getClients = () => {
...
/**
 * functions to run when the template is mounted should go in here
 */
 onMounted(() => {

    /**
     * Get invoice and clients data when 
     * the template has been mounted. 
     */
    getInvoices();
    getClients();
...
//     unpaidInvoices() 
//     {
//         return invoices.filter(invoices.is_paid === false)
//     }
// })
